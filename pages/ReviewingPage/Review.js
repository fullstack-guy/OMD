...
export default function Review(){
  ...
  const handleScaleChange = (event, value) => {
    ...
    return(
        ...
        <div className="grid grid-cols-1 md:grid-cols-2  w-full px-10 lg:px-20  space-x-10">
            <div className=" pt-10 w-full space-y-10">
                ...
                <div className="flex flex-col border-2 border-slate-400 py-2 bg-slate-400 rounded-lg shadow-lg ">
                   ...
                   <div className="flex gap-8 mx-auto mt-3 scale-150 mb-3">
                   <button
        ...
        >
          <SickIcon />
                ...
                <div className="flex-col pt-10 w-full space-y-10">
